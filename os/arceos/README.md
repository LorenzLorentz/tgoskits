...
Install [cargo-binutils](https://github.com/rust-embedded/cargo-binutils) to use `rust-objcopy` and `rust-objdump` tools, and [`ax-config-gen`](https://github.com/arceos-org/axconfig-gen) for kernel configuration, and [axplat-cargo](https://github.com/arceos-org/axplat_crates/tree/dev/cargo-axplat) for platform configuration:

```bash
cargo install cargo-binutils ax-config-gen axplat-cargo
```
