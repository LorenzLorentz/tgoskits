...
//! `crate-fork-audit.md §6`. KALLSYMS lookup goes through PR #805's
//! `crate::kallsyms::lookup_name`, not the source `pseudofs::KALLSYMS`.
...
impl KernelModuleHelper for KmodHelper {
    ...
    fn resolve_symbol(name: &str) -> Option<usize> {
        ...
        match crate::kallsyms::kallsyms_lookup_name(name) {
