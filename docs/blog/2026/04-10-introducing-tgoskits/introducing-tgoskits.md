...
2. [快速开始](/docs/reference/quick-start)
3. [仓库结构](/docs/reference/repo)
4. [组件开发指南](/docs/reference/components)
5. 对应系统指南：[ArceOS](/docs/arceos-guide)、[StarryOS](/docs/starryos-guide)、[Axvisor](/docs/axvisor-guide)
