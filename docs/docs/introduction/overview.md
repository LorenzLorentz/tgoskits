...
详细开发指南：[ArceOS 开发指南](../guides/arceos-guide)
...
详细开发指南：[StarryOS 开发指南](../guides/starryos-guide)
...
详细开发指南：[Axvisor 开发指南](../guides/axvisor-guide)
内部机制：[AxVisor 内部机制](../internals/axvisor-internals)
...
详细说明：[架构与组件层次](../design/architecture/arch) | [依赖图全量分析](../reference/tgoskits-dependency)

## 推荐阅读路径

| 你的目标 | 建议阅读顺序 |
|----------|-------------|
| 第一次进入仓库 | [快速开始](../quickstart/aarch64) → [概览](./overview) → [环境要求](./hardware) |
| 理解命令体系 | [构建流程](../design/build/flow) → [命令总览](../design/build/cmd) |
| 改某个系统 | [系统关系](./guest) → 对应系统指南 (`guides/`) |
| 评估组件影响面 | [架构设计](../design/architecture/arch) → [组件开发指南](../reference/components) |
| 做 Axvisor 开发 | [Axvisor 指南](../guides/axvisor-guide) → [配置体系](../design/guest-config/config-overview) |
