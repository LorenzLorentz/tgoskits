...
- [axvisor-internals.md](../internals/axvisor-internals): 系统理解 Axvisor 的五层架构、VMM 启动链、vCPU 任务模型与 `axvisor_api`
- [components.md](/docs/reference/components): 从组件角度看 Axvisor 与 ArceOS / StarryOS 的共享依赖
- [build-system.md](/docs/reference/build-system): 理解 `cargo axvisor`、辅助脚本和统一测试入口的边界
- [quick-start.md](/docs/reference/quick-start): 如果你只是想先把第一条 QEMU 路径跑通
